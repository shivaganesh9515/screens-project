...
export let mockData = {
  ...
  franchises: [
    { id: "franchise-1", org_id: "org-1", managed_by: "user-3", name: "Downtown District", created_at: "2025-01-01T00:00:00Z" },
    { id: "franchise-2", org_id: "org-1", managed_by: null, name: "Westside Region", created_at: "2025-01-05T00:00:00Z" },
    { id: "franchise-3", org_id: "org-1", managed_by: null, name: "Eastside Territory", created_at: "2025-01-10T00:00:00Z" },
  ],
  screen_groups: [
  ...
  ads: [
    { id: "ad-1", advertiser_id: "adv-1", org_id: "org-1", name: "Summer Sale Banner", media_item_id: "media-1", submitted_by_franchise_id: null, status: "approved", created_at: "2025-03-10T00:00:00Z", advertisers: { name: "PixelPerfect Ads" }, ad_franchise_targets: [{ franchises: { name: "Downtown District" } }, { franchises: { name: "Westside Region" } }] },
    { id: "ad-2", advertiser_id: "adv-1", org_id: "org-1", name: "Product Launch Video", media_item_id: "media-2", submitted_by_franchise_id: null, status: "approved", created_at: "2025-03-20T00:00:00Z", advertisers: { name: "PixelPerfect Ads" }, ad_franchise_targets: [{ franchises: { name: "Downtown District" } }] },
    { id: "ad-3", advertiser_id: "adv-1", org_id: "org-1", name: "Holiday Promo", media_item_id: "media-4", submitted_by_franchise_id: null, status: "pending", created_at: "2025-04-01T00:00:00Z", advertisers: { name: "PixelPerfect Ads" }, ad_franchise_targets: [{ franchises: { name: "Downtown District" } }, { franchises: { name: "Westside Region" } }, { franchises: { name: "Eastside Territory" } }] },
    { id: "ad-4", advertiser_id: "adv-2", org_id: "org-1", name: "New Menu Items", media_item_id: "media-8", submitted_by_franchise_id: null, status: "approved", created_at: "2025-03-25T00:00:00Z", advertisers: { name: "BrightMedia Co." }, ad_franchise_targets: [{ franchises: { name: "Downtown District" } }, { franchises: { name: "Westside Region" } }] },
    { id: "ad-5", advertiser_id: "adv-3", org_id: "org-1", name: "Brand Awareness", media_item_id: "media-3", submitted_by_franchise_id: null, status: "rejected", created_at: "2025-04-05T00:00:00Z", advertisers: { name: "SignagePro" }, ad_franchise_targets: [{ franchises: { name: "Downtown District" } }, { franchises: { name: "Westside Region" } }] },
  ],
  ad_franchise_targets: [
    { id: "aft-1", ad_id: "ad-1", franchise_id: "franchise-1", status: "approved", reviewed_by: null, reviewed_at: null, created_at: "2025-03-12T00:00:00Z", franchises: { name: "Downtown District" } },
    { id: "aft-2", ad_id: "ad-1", franchise_id: "franchise-2", status: "approved", reviewed_by: null, reviewed_at: null, created_at: "2025-03-12T00:00:00Z", franchises: { name: "Westside Region" } },
    { id: "aft-3", ad_id: "ad-1", franchise_id: "franchise-3", status: "pending", reviewed_by: null, reviewed_at: null, created_at: "2025-03-12T00:00:00Z", franchises: { name: "Eastside Territory" } },
    { id: "aft-4", ad_id: "ad-2", franchise_id: "franchise-1", status: "approved", reviewed_by: null, reviewed_at: null, created_at: "2025-03-22T00:00:00Z", franchises: { name: "Downtown District" } },
    { id: "aft-5", ad_id: "ad-2", franchise_id: "franchise-2", status: "pending", reviewed_by: null, reviewed_at: null, created_at: "2025-03-22T00:00:00Z", franchises: { name: "Westside Region" } },
    { id: "aft-6", ad_id: "ad-3", franchise_id: "franchise-1", status: "pending", reviewed_by: null, reviewed_at: null, created_at: "2025-04-05T00:00:00Z", franchises: { name: "Downtown District" } },
    { id: "aft-7", ad_id: "ad-3", franchise_id: "franchise-2", status: "pending", reviewed_by: null, reviewed_at: null, created_at: "2025-04-05T00:00:00Z", franchises: { name: "Westside Region" } },
    { id: "aft-8", ad_id: "ad-3", franchise_id: "franchise-3", status: "pending", reviewed_by: null, reviewed_at: null, created_at: "2025-04-05T00:00:00Z", franchises: { name: "Eastside Territory" } },
    { id: "aft-9", ad_id: "ad-4", franchise_id: "franchise-1", status: "approved", reviewed_by: null, reviewed_at: null, created_at: "2025-03-28T00:00:00Z", franchises: { name: "Downtown District" } },
    { id: "aft-10", ad_id: "ad-4", franchise_id: "franchise-2", status: "approved", reviewed_by: null, reviewed_at: null, created_at: "2025-03-28T00:00:00Z", franchises: { name: "Westside Region" } },
    { id: "aft-11", ad_id: "ad-4", franchise_id: "franchise-3", status: "rejected", reviewed_by: null, reviewed_at: null, created_at: "2025-03-28T00:00:00Z", franchises: { name: "Eastside Territory" } },
    { id: "aft-12", ad_id: "ad-5", franchise_id: "franchise-1", status: "rejected", reviewed_by: null, reviewed_at: null, created_at: "2025-04-08T00:00:00Z", franchises: { name: "Downtown District" } },
    { id: "aft-13", ad_id: "ad-5", franchise_id: "franchise-2", status: "rejected", reviewed_by: null, reviewed_at: null, created_at: "2025-04-08T00:00:00Z", franchises: { name: "Westside Region" } },
  ],
  screen_locations: [
