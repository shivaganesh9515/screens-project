...
export let mockData = {
  ...
  screens: [
    ...
    { id: "screen-2", org_id: "org-1", group_id: "group-1", anon_user_id: null, name: "Second Floor Lobby", pairing_code: null, pairing_expires_at: null, paired_at: "2025-01-20T10:00:00Z", last_seen: new Date(Date.now() - 120000).toISOString(), is_online: true, resolution: "3840x2160", tags: ["lobby", "4k"], latitude: 37.7755, longitude: -122.4185, screen_type: "static", created_at: "2025-01-18T00:00:00Z", screen_groups: { name: "Lobby" } },
    { id: "screen-3", org_id: "org-1", group_id: "group-2", anon_user_id: null, name: "Board Room", pairing_code: null, pairing_expires_at: null, paired_at: "2025-02-01T09:00:00Z", last_seen: new Date(Date.now() - 3600000).toISOString(), is_online: true, resolution: "1920x1080", tags: ["conference"], latitude: 37.7745, longitude: -122.4200, screen_type: "static", created_at: "2025-01-25T00:00:00Z", screen_groups: { name: "Conference Rooms" } },
    { id: "screen-4", org_id: "org-1", group_id: null, anon_user_id: null, name: "Warehouse Display", pairing_code: null, pairing_expires_at: null, paired_at: "2025-02-10T14:00:00Z", last_seen: new Date(Date.now() - 86400000).toISOString(), is_online: false, resolution: "1920x1080", tags: ["warehouse"], latitude: 37.7760, longitude: -122.4170, screen_type: "static", created_at: "2025-02-05T00:00:00Z", screen_groups: null },
    { id: "screen-5", org_id: "org-1", group_id: "group-3", anon_user_id: null, name: "Cafeteria Menu Board", pairing_code: null, pairing_expires_at: null, paired_at: "2025-02-15T11:00:00Z", last_seen: new Date(Date.now() - 1800000).toISOString(), is_online: true, resolution: "1920x1080", tags: ["cafeteria", "menu"], latitude: 37.7735, longitude: -122.4210, screen_type: "static", created_at: "2025-02-12T00:00:00Z", screen_groups: { name: "Cafeteria" } },
    { id: "screen-6", org_id: "org-1", group_id: null, anon_user_id: null, name: "Downtown Bus #12", pairing_code: null, pairing_expires_at: null, paired_at: "2025-03-01T08:00:00Z", last_seen: new Date(Date.now() - 120000).toISOString(), is_online: true, resolution: "1920x720", tags: ["bus", "transit"], latitude: 37.7785, longitude: -122.4230, screen_type: "bus", created_at: "2025-02-20T00:00:00Z", screen_groups: null },
    { id: "screen-7", org_id: "org-1", group_id: null, anon_user_id: null, name: "Company Van #3", pairing_code: null, pairing_expires_at: null, paired_at: "2025-03-10T09:00:00Z", last_seen: new Date(Date.now() - 300000).toISOString(), is_online: true, resolution: "1920x1080", tags: ["vehicle", "mobile"], latitude: 37.7710, longitude: -122.4150, screen_type: "auto", created_at: "2025-03-01T00:00:00Z", screen_groups: null },
  ],
  screen_locations: [
    { id: "sl-1", screen_id: "screen-6", latitude: 37.7785, longitude: -122.4230, recorded_at: new Date(Date.now() - 120000).toISOString() },
    { id: "sl-2", screen_id: "screen-6", latitude: 37.7800, longitude: -122.4250, recorded_at: new Date(Date.now() - 300000).toISOString() },
    { id: "sl-3", screen_id: "screen-6", latitude: 37.7820, longitude: -122.4270, recorded_at: new Date(Date.now() - 600000).toISOString() },
    { id: "sl-4", screen_id: "screen-7", latitude: 37.7710, longitude: -122.4150, recorded_at: new Date(Date.now() - 300000).toISOString() },
    { id: "sl-5", screen_id: "screen-7", latitude: 37.7690, longitude: -122.4130, recorded_at: new Date(Date.now() - 900000).toISOString() },
    { id: "sl-6", screen_id: "screen-7", latitude: 37.7670, longitude: -122.4110, recorded_at: new Date(Date.now() - 1800000).toISOString() },
  ],
  media_items: [
